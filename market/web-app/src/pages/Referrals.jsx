  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 pb-safe">
      ...
      <div className="p-4 max-w-lg mx-auto w-full">
        <div className="bg-gradient-to-br from-primary to-orange-400 rounded-2xl p-6 text-white text-center mb-6 shadow-lg shadow-orange-500/20">
          ...
          <div className="bg-white/20 p-3 rounded-lg backdrop-blur-sm flex items-center justify-between mb-4">
            ...
            <button onClick={copyCode} className="bg-white text-primary p-2 rounded flex items-center gap-1 text-sm font-bold hover:bg-gray-100 transition-colors">
        ...
        <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
          <h3 className="font-bold text-gray-900 flex items-center gap-2 mb-4">
            <Users className="w-5 h-5 text-primary" /> Mis Referidos (0)
          </h3>
