...
export interface LuisInventoryItem {
    id: string;
    productId: string;
    productName: string;
    sku: string;
...
class LuisInventoryService {
    private collectionName = 'luisInventory';

    async getAll(): Promise<LuisInventoryItem[]> {
...
export const luisInventoryService = new LuisInventoryService();
