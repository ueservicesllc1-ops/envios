...
export interface MariaInventoryItem {
    id: string;
    productId: string;
    productName: string;
    sku: string;
...
class MariaInventoryService {
    private collectionName = 'mariaInventory';

    async getAll(): Promise<MariaInventoryItem[]> {
...
export const mariaInventoryService = new MariaInventoryService();
