...
export interface YuriInventoryItem {
    id: string;
    productId: string;
    productName: string;
    sku: string;
...
class YuriInventoryService {
    private collectionName = 'yuriInventory';

    async getAll(): Promise<YuriInventoryItem[]> {
...
export const yuriInventoryService = new YuriInventoryService();
